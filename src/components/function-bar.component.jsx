    ...
    return (
        <div className={functionbar_style}>
            ...
            <div className='relative'>
                ...
                <input onChange={handleChange} className='pl-9 py-1.5 outline-none rounded-md border-2 transition-colors duration-150 
                    focus:border-blue-400' type="text" defaultValue={searchContent} placeholder='search task...' />
            </div>
        </div>
    );
}