            ...
            <div className=' basis-1/3 space-y-10 p-4'>
                <div className=' text-center space-y-2'>
                    ...
                    }
                    {
                        action === 'forgot' &&
                        <>
                            <h1 className='text-4xl font-bold'>Find your password</h1>
                            <p>
                                Or{' '}
                                <Link to="/signin" className='transition-colors delay-75 font-medium outline-none text-blue-600 hover:text-blue-400 focus:text-blue-400'> sign in here</Link>
                            </p>
                        </>
                    }
                </div>
                ...
                {
                    action === 'forgot' && <ForgotPasswordForm />
                }
            </div>
        </div>
    );
